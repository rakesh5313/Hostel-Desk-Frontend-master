                ...
                <div >
                    <Form className="myForm" onSubmit={this.handleSubmit}>
                        <Row form>
                            ...
                            <Col md={4}>
                                <FormGroup>
                                    <Label for="block"> People</Label>
                                    <Input required type="text" name="block" id="Block" value={this.state.block} placeholder="People No"
                        ...
                        <Row form>
                            <Col md={4}>
                                <FormGroup>
                                    ...
                                    <Input required type="number" name="rent" id="rent" value={this.state.rent} placeholder="Rent"
