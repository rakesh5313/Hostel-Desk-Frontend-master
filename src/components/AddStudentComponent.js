            ...
            <div>
                <div className="row">
                    <div className="col-12 container-fluid">
                        <h2 className="feature-heading ">Add New Events</h2>
                ...
                <div >
                    <Form className="myForm" onSubmit={this.handleSubmit}>
                        <Row form>
                            ...
                            <Col md={3}>
                                <FormGroup>
                                    <Label for="id">Id(As Login Id)</Label>
                                    <Input required type="text" name="id" id="id" placeholder=" Id" value={this.state.id}
