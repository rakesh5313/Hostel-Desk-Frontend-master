        ...
        <Navbar light expand="md" className="me" >
          ...
          <Collapse isOpen={this.state.isNavOpen} navbar >
            <Nav navbar className="flex-column">
              ...
              <NavItem>
                <Link className="nav-link" id="toggler1" onClick={this.toggleStudentManage} to="/admin/StudentsManage"> <i className="fa fa-child" aria-hidden="true"></i> Event Manager <Carrot open={this.state.isstudentmanageopen} /></Link>
              </NavItem>
              <div>
...
<NavItem>
                <Link className="nav-link" id="toggler1" onClick={this.toggleStudentManage} to="/admin/StudentsManage"> <i className="fa fa-child" aria-hidden="true"></i> Travel Manage <Carrot open={this.state.isstudentmanageopen} /></Link>
              </NavItem>
              <div>
                <UncontrolledCollapse toggler="#toggler1">
                  <NavItem>
