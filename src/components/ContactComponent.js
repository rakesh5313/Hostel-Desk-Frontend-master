        ...
        <div className="container-fluid contact">
            ...
            <div className="row row-content">
                ...
                <div className="col-12 col-md-4 offset-md-2">
                    ...
                    <a href="http://maps.google.com/?q=Punjab Engineering College, Sector-12" target="_blank" rel="noreferrer noopener"><i className="fa fa-map-marker-alt fa-2x info"></i></a><div className="text"><p><strong>Location:</strong><br />KL UNIVERSITY<br />RIMO</p></div>
                    <a href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=deansw@pec.edu.in" target="_blank" rel="noreferrer noopener"> <i className="fa fa-envelope fa-2x info"></i></a><div className="text"><p><strong>Email:</strong><br />rimo@yourevent.in</p></div>
                    <a href="tel:+1722753071" target="_blank" rel="noreferrer noopener"> <i className="fa fa-phone-alt fa-2x info"></i></a><div className="text"><p><strong>Call:</strong><br />+917995550627</p></div>
                </div>
